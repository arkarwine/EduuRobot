...
COMMAND_USAGES = {
    ...
    "antispam": (
        "/antispam [on|off|feature on/off|flood limit seconds|repeat limit seconds|mute minutes]"
    ),
    "anybody": "/anybody <text> or reply with /anybody",
    "addreply": "/addreply <text> or reply with /addreply [keywords]",
    "autoreply": "/autoreply [on|off|mode random|keyword|chance|cooldown|rate]",
    "ban": "/ban <user> [reason] or reply with /ban [reason]",
    "broadcast": "/broadcast as a reply to the message to send",
    ...
    "dice": "/dice",
    "dog": "/dog",
    "emoji": "/emoji <premium emoji, custom emoji ID, or t.me/addemoji link> or reply with /emoji",
    "filter": '/filter "trigger" <response> or reply with /filter "trigger"',
    "filters": "/filters",
    "gif": "/gif <search term>",
    "getgoodbye": "/getgoodbye",
    "getdefaultgoodbye": "/getdefaultgoodbye",
    "getdefaultwelcome": "/getdefaultwelcome",
    ...
    "delete_all_replies": "/delete_all_replies",
    "reaction": "/reaction [on|off|chance <0-100>|add <emoji>|remove <emoji>]",
    "replies": "/replies",
    ...
    "setgoodbye": "/setgoodbye as a reply to the new goodbye message",
    "setdefaultgoodbye": "/setdefaultgoodbye <text> or reply with /setdefaultgoodbye",
    "setdefaultwelcome": "/setdefaultwelcome <text> or reply with /setdefaultwelcome",
