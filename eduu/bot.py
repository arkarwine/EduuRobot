...
from eduu.utils.feature_flags import effective_disabled_plugins, env_bool, load_dotenv
...
load_dotenv()
ACTIVE_DISABLED_PLUGINS = effective_disabled_plugins(
    DISABLED_PLUGINS,
    auto_reply_enabled=env_bool(
        "AUTO_REPLY_ENABLED",
        getattr(app_config, "AUTO_REPLY_ENABLED", True),
    ),
    auto_download_enabled=env_bool(
        "AUTO_DOWNLOAD_ENABLED",
        getattr(app_config, "AUTO_DOWNLOAD_ENABLED", True),
    ),
)
